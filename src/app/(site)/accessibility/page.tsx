  ...
  return (
    <main className="flex-1 px-6 pb-20 pt-12 sm:pt-16">
      <div className="mx-auto flex max-w-3xl flex-col gap-8">
        <h1 className="font-display text-5xl font-semibold text-text-primary">Accessibility</h1>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="text-lg font-semibold text-text-primary">What that means in practice</h2>
          <ul className="flex list-disc flex-col gap-2 pl-5 leading-relaxed text-text-secondary">
            ...
            <li>Text and controls meet AA colour contrast, and nothing relies on colour alone.</li>
            <li>Times that can&apos;t be booked say why in words, not just by looking faded.</li>
        ...
        <section className="flex flex-col gap-3">
          <h2 className="text-lg font-semibold text-text-primary">Known limitation</h2>
          <p className="leading-relaxed text-text-secondary">
            The card payment form is provided by Stripe inside a secure frame. We don&apos;t control its markup, but Stripe
            publishes its own accessibility work for it.
          </p>
        </section>

        <section className="flex flex-col gap-3">
          <h2 className="text-lg font-semibold text-text-primary">Something not working?</h2>
          <p className="leading-relaxed text-text-secondary">
            Tell us and we&apos;ll fix it, and help you book in the meantime. Email{" "}
